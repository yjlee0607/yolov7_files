...
from models.yolo_nptk import Model
...
def test(data,
    ...
    names = {k: v for k, v in enumerate(cfg_model.names if hasattr(cfg_model, 'names') else cfg_model.module.names)}
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            # Run model
            t = time_synchronized()
            out, train_out = cfg_model.model[-1].post_processing(model(img))  # inference and training outputs
